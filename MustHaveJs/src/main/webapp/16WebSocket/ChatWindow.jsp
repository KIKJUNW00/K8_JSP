...
<title>웹소켓 채팅</title>
	...
	<script>
		...
		//엔터키 입력처리
		function enterKey() {
			if (window.event.keyCode == 13) { //13은 엔터키의 코드값
				sendMessage();	
			}
		}
	...
	<style>
		...
		#chatId{width: 158; height: 24px; border: 1px solid #AAAAAA; background-color: #EEEEEE;}
